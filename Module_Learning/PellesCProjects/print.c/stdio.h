...
#if __POCC__ < 900
#error <stdio.h> need POCC version 9.0 or higher
#endif /* __POCC__ < 900 */
...
extern _CRTUSE FILE * __cdecl tmpfile(void);
...
extern _CRTUSE FILE * __cdecl fopen(const char * restrict, const char * restrict);
extern int __cdecl setvbuf(FILE * restrict, char * restrict, int, size_t);
extern _CRTUSE FILE * __cdecl freopen(const char * restrict, const char * restrict, FILE * restrict);
...
extern int __cdecl vprintf(const char * restrict, va_list);
extern _CRTCHK(printf,1,2) int __cdecl printf(const char * restrict, ...);
...
extern _CRTUSE FILE * __cdecl _wfopen(const wchar_t * restrict, const wchar_t * restrict);
extern _CRTUSE FILE * __cdecl _wfreopen(const wchar_t * restrict, const wchar_t * restrict, FILE * restrict);
extern _CRTUSE FILE * __cdecl _fdopen(int, const char *);
extern _CRTUSE FILE * __cdecl _wfdopen(int, const wchar_t *);
extern _CRTUSE FILE * __cdecl _popen(const char *, const char *);  /* 06-03-13 */
...
/* operations on files */
extern _CRTUSE errno_t __cdecl tmpfile_s(FILE * restrict * restrict);
extern _CRTUSE errno_t __cdecl tmpnam_s(char *, rsize_t);

/* file access functions */
extern _CRTUSE errno_t __cdecl fopen_s(FILE * restrict * restrict, const char * restrict, const char * restrict);
extern _CRTUSE errno_t __cdecl freopen_s(FILE * restrict * restrict, const char * restrict, const char * restrict, FILE * restrict);
...
/* private extensions */
extern _CRTUSE errno_t __cdecl _wfopen_s(FILE * restrict * restrict, const wchar_t * restrict, const wchar_t * restrict);
extern _CRTUSE errno_t __cdecl _wfreopen_s(FILE * restrict * restrict, const wchar_t * restrict, const wchar_t * restrict, FILE * restrict);
...
extern _CRTUSE FILE * __cdecl fmemopen(void * restrict, size_t, const char * restrict);
extern _CRTUSE FILE * __cdecl open_memstream(char ** restrict, size_t * restrict);
